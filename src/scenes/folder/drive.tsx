...
export function UserRecordsExplorer({
    setPage,
    page,
    isShared,
    data,
    ...
    const [driveData, setdriveData] = useState<ContentType[]>(data.data);
    ...
    const handleMoveConfirm = async (parenturl: string) => {
        try {
