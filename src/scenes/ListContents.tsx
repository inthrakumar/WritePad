...
export default function ListContents({ folderdata }: { folderdata: folderContents | null }): ReactElement {
  if (!folderdata) {
    return (
  ...
  return (
    <div className="w-full flex flex-col space-y-4">
      ...
      <div className="flex flex-col space-y-4">
        {folderdata.map((item) => (
          <div key={item._id.toString()} className="flex items-center space-x-4 text-sm p-4 border rounded-md shadow-sm">
